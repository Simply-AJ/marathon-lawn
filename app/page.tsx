...
export default function Home(){
  ...
  return <main id="top" className="ml-page">
    ...
    <section className="ml-section ml-how"><div className="ml-container ml-how-grid"><div><p className="ml-eyebrow">HOW IT WORKS</p><h2 className="ml-display">A simple process. A consistently great-looking lawn.</h2></div><div className="ml-steps"><div className="ml-step"><span>1</span><div><b>Request a Quote</b><small>Fill out our quick form or give us a call.</small></div></div><div className="ml-step"><span>2</span><div><b>Get Scheduled</b><small>We&apos;ll confirm your service and get you on the calendar.</small></div></div><div className="ml-step"><span>3</span><div><b>We Take Care of the Rest</b><small>Same person. Every time. You enjoy the results.</small></div></div></div><div className="ml-matters"><img src={workImages[1]} alt="Well-kept lawn"/><div className="ml-matters-copy"><strong>More Time for<br/>What Matters</strong><small>Let us handle the lawn, so you can get back to the things you love.</small></div></div></div></section>
